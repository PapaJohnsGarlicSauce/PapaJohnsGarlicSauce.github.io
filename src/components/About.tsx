  ...
  return (
    <div className="about-content">
      ...
      <p className="descriptive-text">
        ...
        database flavors (PostgreSQL, Microsoft SQL Server, MySQL). I love to
        learn, so I'm always experiementing with new technologies and languages.
      </p>
      <p className="descriptive-text">
      ...
      <p className="descriptive-text">
        You can contact me <a href="/contact">here</a> or feel free to reach out
        to me on{" "}
